...
combine l nil = l
combine nil l = l
combine (h::t) (x :: y) = ite (member h (x :: y))
                              (combine (t) (x :: y))
                              (h :: (combine t (x :: y)))
...
list_difference (h :: t) l = ite (member h l)
                                  (list_difference t (list_remove h l))
...
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
set_exists p (mkSet l) = (list.foldr bool.or false (map p l))
...
--pairelt takes an elt h and a list b and returns a list of all pairs, (h, e)
-- where e is an element of the list b
